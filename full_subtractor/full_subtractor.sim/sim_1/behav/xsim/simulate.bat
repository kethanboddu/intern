...
REM
REM Generated by Vivado on Wed Jun 03 16:26:00 +0530 2026
...
call xsim  fs_tb_behav -key {Behavioral:sim_1:Functional:fs_tb} -tclbatch fs_tb.tcl -log simulate.log
